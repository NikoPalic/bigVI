...
class DocumentLoader:
    def __init__(self, dataset="20news",cutin=0,cutoff=100): #needs list of documents
        if dataset=="20news":
            self.dataset=fetch_20newsgroups(subset="train").data[cutin:cutoff]
        else:
            self.dataset = dataset[cutin:cutoff]
